...
githubURL: "https://github.com/manh-td/arxiv-recent"
---

# arXiv Recent

Nhấn `Pass` nếu bạn muốn bỏ qua sang bài tiếp theo.  
Nhấn `Interesting` *(kèm `Ctrl`/`Command` để ở lại trang này)* nếu bạn quan tâm muốn đọc bài này.  
Thay đổi chủ đề bằng `Select Subject` *(hiện có 'Software Engineering' — `cs.SE` và 'Cryptography and Security' — `cs.CR`)*
    ...
    <div class="d-flex justify-content-end pb-1">
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-3" aria-labelledby="datePickerDropdown">
                <select class="form-control mb-2" id="selectedDate">
